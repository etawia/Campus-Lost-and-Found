  ...
  Widget lostCard(name, description, itemLost, location, dateTime, uid) {
    Future<String> getDownloadLinkImage1() async {
      StorageReference storageReference = FirebaseStorage.instance
          .ref()
          .child("gs://tt-mini-project.appspot.com/$uid+image1.jpg");
    ...
    Future<String> getDownloadLinkImage2() async {
      StorageReference storageReference = FirebaseStorage.instance
          .ref()
          .child("gs://tt-mini-project.appspot.com/$uid+image2.jpg");
      //child("/$uid+image2");
      if (storageReference != null) {
        print("STORE UID 2 -> $uid");
    ...
    DateTime date1 = dateTimestamp.toDate();
